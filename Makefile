...
SOURCEFILES := Source/imusoconn.cpp Source/ini.cpp Source/INIReader.cpp Source/SharedMemGrabber.cpp Source/Tcl.cpp Source/Traff.cpp
HEADERS := Source/SharedMemGrabber.h Source/Traffstate.h
EXTERNAL_LIBS := 
...
$(BINARYDIR)/imusoconn.o : Source/imusoconn.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/ini.o : Source/ini.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/INIReader.o : Source/INIReader.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/SharedMemGrabber.o : Source/SharedMemGrabber.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/Tcl.o : Source/Tcl.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/Traff.o : Source/Traff.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)
